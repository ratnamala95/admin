      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('Dashboard');?>"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?php echo site_url('Dashboard');?>"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo site_url('Dashboard/register');?>"><i class="fa fa-circle-o"></i> Register</a></li>
          </ul>
        </li>
      </ul>
    </section>
